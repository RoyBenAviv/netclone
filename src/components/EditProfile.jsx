      ...
      <div className="edit-profile-wrapper">
        <div className="edit-profile-container">
          ...
          <div className="profile">
            ...
            <img className="profile-image" src={require(`../assets/images/profiles/${profile.image}.png`)} alt="edit-profile" />
              <span>
          ...
          <div className="actions">
            <button onClick={() => onSaveProfile()}>Save</button> <button onClick={() => setEditProfile(null)}>Cancel</button> <button style={user.profiles.length === 1 ? {display: 'none'} : {display: 'block'}} onClick={() => deleteProfile()}>Delete Profile</button>
          </div>
        </div>
      </div>
    </section>
